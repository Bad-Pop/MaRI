...
class AdDeleterServiceTest {

  @Nested
  class SuccessfulDeletion {

    private final AdDeleterService service = new AdDeleterService(new OkSpi());
    ...
    private static class OkSpi implements AdDeleterSpi {
      @Override
  ...
  class DeletionFailure {
    ...
    private final AdDeleterService service = new AdDeleterService(new KoSpi());
    ...
    private static class KoSpi implements AdDeleterSpi {
      @Override
      public Either<MariFail, Void> deleteById(String id) {
